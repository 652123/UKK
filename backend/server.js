...
// Hardcoded template to avoid file read issues on Serverless
const CONFIG_TEMPLATE = `
// config.js generated by server
...
if (typeof Swal !== 'undefined') {
    ...
    window.Swal = originalSwal.mixin({
        ...
        buttonsStyling: true,
        customClass: {
            popup: 'border border-white/10 rounded-2xl shadow-[0_0_50px_rgba(139,92,246,0.15)]',
...
app.get(['/config.js', '/api/config.js'], (req, res) => {
    ...
    const processedConfig = CONFIG_TEMPLATE
        ...
        .replace(/'__API_BASE_URL__'/g, `'${process.env.API_BASE_URL || ''}'`);
